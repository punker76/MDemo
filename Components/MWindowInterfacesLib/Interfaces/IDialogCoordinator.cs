namespace MWindowInterfacesLib.Interfaces
{
    ...
    public interface IDialogCoordinator
    {
        ...
        Task<TDialog> GetCurrentDialogAsync<TDialog>(object context) where TDialog : IBaseMetroDialog;
        ...
        Task<MessageDialogResult> ShowMessageAsync(object context, string title, string message, MessageDialogStyle style = MessageDialogStyle.Affirmative, IMetroDialogSettings settings = null);
        ...
        Task<IProgressDialogController> ShowProgressAsync(object context, string title, string message,
            bool isCancelable = false, IMetroDialogSettings settings = null);
        ...
        Task ShowMetroDialogAsync(object context, IBaseMetroDialog dialog,
        ...
        /// </exception>
        Task HideMetroDialogAsync(object context, IBaseMetroDialog dialog, IMetroDialogSettings settings = null);
