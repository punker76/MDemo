namespace MWindowDialogLib.Dialogs
{
    ...
    {
        internal ProgressDialog(IMetroWindow parentWindow)
            : this(parentWindow, null)
        {
        }

        internal ProgressDialog(IMetroWindow parentWindow, IMetroDialogSettings settings)
        ...
        protected override void OnLoaded()
        {
            ...
            this.SetResourceReference(ProgressBarForegroundProperty
                                    , "BlackBrush" //// this.DialogSettings.ColorScheme == MetroDialogColorScheme.Theme ? "AccentColorBrush" : "BlackBrush"
                                    );
        }
