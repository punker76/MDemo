namespace MWindowDialogLib.Internal
{
    ...
    internal class ProgressDialogController : IProgressDialogController
    {
        ...
        internal static IProgressDialogController Create(ProgressDialog dialog, Func<Task> closeCallBack)
        {
            var progress = new ProgressDialogController(dialog, closeCallBack);
