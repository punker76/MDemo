                                          ...
                                          , IAppearanceManager appearance)
        {
            try
            {
                ...
                appearance.AddThemeResources("Dark", new List<Uri>
                {
                   ...
                   //,new Uri("/MsgBox;component/View/Modern/Themes/ModernUI.Dark.xaml", UriKind.RelativeOrAbsolute)
                   //,new Uri("/MDemo;component/Themes/Dark/MsgBox/ModernUI.Dark.xaml", UriKind.RelativeOrAbsolute)

                   ,new Uri("/MWindowLib;component/Controls/Accent/BaseDark.xaml", UriKind.RelativeOrAbsolute)
