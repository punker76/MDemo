namespace MDemo
{
    ...
    public static class ServiceInjector
    {
        ...
        {
            ServiceContainer.Instance.AddService<IMetroWindowService>(MetroWindowService.Instance);
////            ServiceContainer.Instance.AddService<IMessageBoxService>(MessageBoxService.Instance);
